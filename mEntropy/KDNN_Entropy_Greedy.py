...
def knn(pS, fTs, pid, k, wFTs):
    """
    Algorithm will compute the diversity/ entropy each time when a new neighbor added choose k out of k+1 neighbors 
    found, and calculate to have the max entropy sets. Assign a final entropy from local entropy
